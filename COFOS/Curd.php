...
<body>
    ...
    <div class="container">
		<div class="hierarchy">
			<p>	<a href="home.php">Home</a><font color="white"> > </font><a href="Curd.php">Curd & Buttermilk</a> </p>
		</div>
	</div>	

  	<div class="jumbotron">
	    <h1 id="Curd">Curd & Buttermilk</h1>
	</div>		
    ...
    $_SESSION['category']='curd_buttermilk';
