...
<head>
	...
	<link rel="stylesheet" type="text/css" href="ETI.css">
...
<body>
    ...
    <div class="container">
		<div class="hierarchy">
			<p>	<a href="home.php">Home</a><font color="white"> > </font><a href="ETI.php">Extra Tandoori</a> </p>
		</div>
	</div>	

  	<div class="jumbotron">
	    <h1 id="ETI">Extra Tandoori</h1>
	</div>		
    ...
    $_SESSION['category']='extratandooriitems';
