...
<body>
    ...
    <div class="container">
		<div class="hierarchy">
			<p>	<a href="home.php">Home</a><font color="white"> > </font><a href="BPC.php">Bhajipav</a> </p>
		</div>
	</div>	

  	<div class="jumbotron">
	    <h1 id="Bhajipav">Bhajipav</h1>
	</div>		
    ...
    $_SESSION['category']='bhajipav_chats';
